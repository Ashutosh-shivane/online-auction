							...
							<div class="rd-navbar-main-element">
								<div class="rd-navbar-nav-wrap toggle-original-elements">
									<ul class="rd-navbar-nav">
										...
										<li class="rd-nav-item active"><a class="rd-nav-link"
											href="SellerAddProduct.jsp">Add Product</a></li>
		...
		<div class="container">
			...
			<div class="card border-0">
				<div class="card-header bg-primary text-center p-4">
					<h3 class="text-white m-0">Add Product Information</h3>
				</div>
				<div class="card-body rounded-bottom bg-primary p-5">
					<form method="post" action="SellerAddProductProcess.jsp">


						<div class="form-group">
							<input id="prod_name" name="prod_name" type="text"
								class="form-control p-4" placeholder="Enter Product Name"
								required="required" >
						</div>

						<div class="form-group">
							<input id="prod_price" name="prod_price" type="text"
								class="form-control p-4" placeholder="Enter Price"
								required="required" >
						</div>

						<div class="form-group">
							<textarea id="prod_info" name="prod_info" rows="4" cols="50"
								class="form-control p-4"
								placeholder="Product Information" required="required"></textarea>
						</div>

						<div class="form-group">
							<input type="file" id="photo" placeholder="Enter Photo"
								name="photo">
						</div>


						<div>
							<button class="btn btn-light btn-block py-3" type="submit">Add Product</button>
						</div>
					</form>
				</div>
			</div>
