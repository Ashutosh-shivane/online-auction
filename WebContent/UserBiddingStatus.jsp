...
<body class="">
 ...
 -->
										...
										v-item active"><a class="rd-nav-link"
											href="UserHome.jsp">User Home</a></li>
		...
		<%
			...
			PreparedStatement ps = con.prepareStatement("select * from bidding where uid=?",
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td>
					<a class="btn btn-secondary"  role="button" aria-disabled="true">Bid Pending</a>
					</td>
