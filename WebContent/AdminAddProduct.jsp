...
<body class="">
	...
	<div class="page animated" style="animation-duration: 500ms;">
		...
		<%
			...
			PreparedStatement ps = con.prepareStatement("select * from seller_product where status='0'",
				...
				<div class="col-xl-3 col-lg-4 col-sm-6">
					...
					<div class="post-modern">
						...
						<div class="post-modern-caption">
							...
							<a class="button button-box-right button-primary button-lg"
								href="AdminAddProductProcess.jsp?spid=<%=rs.getString(1)%>">Add Product
							</a> 
						</div>
					</div>
				</div>
