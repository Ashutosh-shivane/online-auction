								...
								<div class="rd-navbar-nav-wrap toggle-original-elements">
									<ul class="rd-navbar-nav">
										...
										<!-- 	<li class="rd-nav-item active"><a class="rd-nav-link"
											href="SellerHome.jsp">Home</a></li>
 -->
										<li class="rd-na
										v-item active"><a class="rd-nav-link"
											href="UserBiddingStatus.jsp">Click To Show Success & Pending Bidding</a></li>
		...
		<div class="container">
			<h3>Current Available Bidding Products Are </h3>
				...
				<div class="col-xl-3 col-lg-4 col-sm-6">
					...
					<div class="post-modern">
						...
						<figure class="post-modern-figure">
							<img src="data:image/jpeg;base64,${imgBase}" alt="" width="270"
								height="108">
						</figure>
						<div class="post-modern-caption">
							...
							<form method="get" action="UserBiddingProcess.jsp">
								
								<input name="uid" type="hidden" value="<%=session.getAttribute("uid") %>">
								<input name="pid" type="hidden" value="<%=rs.getString(1)%>">
								<input name="pname" type="hidden" value="<%=rs.getString(2)%>">		
								<div class="form-row">
									<div class="form-group  col-md-12">
										<input name="bidamt" type="text" class="form-control p-4"
											placeholder="Enter Bidding Amount" required="required">
									</div>
								</div>
								<div>
									<button class="btn btn-primary btn-block py-3" type="submit">Bidding
										Now</button>
								</div>
							</form>
						</div>
				...
				<div class="col-xl-3 col-lg-4 col-sm-6">
					...
					<div class="post-modern">
						...
						<div class="post-modern-caption">
							...
							<form method="post" action="UserBiddingProcess.jsp">
