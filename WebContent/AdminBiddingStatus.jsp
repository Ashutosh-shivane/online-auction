...
<body class="">
 ...
 -->
		...
		<%
			...
			PreparedStatement ps = con.prepareStatement("select * from bidding order by pname",
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td>
					<a class="btn btn-secondary"  role="button" aria-disabled="true" href="AdmingBiddingAction.jsp?bid=<%=rs.getString(1)%>">Click To Bid Pending</a>
					</td>
					
					<%} else {%>
					<td>
					<a class="btn btn-primary"  role="button" aria-disabled="true">BidFinal</a>
					</td>
					<% } %>
				</tr>
				<%
